          ...
          <div className=" flex flex-col w-full h-full gap-5">
              ...
              >
                <div className="opacity-0 group-hover:opacity-100">
                  ...
                  <div className="pt-8 text-center">
                    ...
                    <a
                      href="https://project-space-three.vercel.app/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
            ...
            <div className=" w-[80%] h-full">
              <div
                ...
                className=" h-full rounded-2xl shadow-lg shadow-[#040c16] group container  flex justify-center text-center items-center mx-auto"
              >
                <div className="opacity-0 group-hover:opacity-100 bg-black p-5 rounded-lg ">
                  <span className="text-center rounded-lg px-4 py-4 m-2 text-white font-bold text-2xl tracking-wider">
                    Pet-Sitter
                  </span>
                  <div className="pt-8 text-center">
                    <a
                      href="https://github.com/nathkit/petsitter"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
                    ...
                    <a
                      href="https://pet-sitter-53f4f.web.app/"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                      <button className="text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg">
